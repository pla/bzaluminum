...
if mods.bzsilicon and util.me.byproduct() and not mods.Krastorio2 then
  alumina_results ={
    {type="item", name = "alumina", amount=1, independent_bility=0.95},
    {type="item", name = "silica", amount=1, independent_probability=0.05},
  }
elseif mods.bzsilicon and util.me.byproduct() and mods.Krastorio2 then
  alumina_results ={
    {type="item", name = "alumina", amount=5, independent_probability=0.95},
    {type="item", name = "silica", amount=1, independent_probability=0.25},
  }
...
data:extend({
  ...
  if mods.bzsilicon then
    ...
    util.replace_some_ingredient("landfill-silica", "stone", 10, "silica", mods["space-exploration"] and 100 or 20)
    ...
    util.set_icons("landfill-silica", {
      {
        icon = data.raw.item["landfill"].icon,
        icon_size = data.raw.item["landfill"].icon_size,
        icon_mipmaps = data.raw.item["landfill"].icon_mipmaps,
      },
      {
        icon = data.raw.item["silica"].icon,
        icon_size = data.raw.item["silica"].icon_size,
        icon_mipmaps = data.raw.item["silica"].icon_mipmaps,
        scale = 0.25,
        shift = { 8, -8 },
      },
    })
  ...
  data:extend({
    ...
    },
    {
      ...
      enabled = false,
      energy_required = 0.5,
      ingredients = { { type = "item", name = "aluminum-cable", amount = 6 }, {
        type = "item",
        name = "steel-plate",
        amount = 1,
      } },
    ...
    data:extend({
      {
        ...
        categories = { "kr-smelting-crafting" },
  ...
  if mods.bztitanium then
    ...
    if mods.bzcarbon then
      ...
      util.add_product(
        "ti-sapphire",
        { type = "item", name = "diamond", amount = 1, independent_probability = 0.8, catalyst_amount = 1 },
        { force = true }
      )
    end
  end
